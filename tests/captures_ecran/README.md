# Captures d’écran – Semaine 1

Ce dossier contient les preuves visuelles de la mise en place et des tests du laboratoire virtuel.

## Contenu

- `virtualbox_vues_ensemble.png` : vue globale des machines virtuelles dans VirtualBox.
...
- `test_acces_serveur_web.png` : accès au serveur Web depuis un client.

Ces captures illustrent les tests de connectivité et la configuration réseau de la Semaine 1.
